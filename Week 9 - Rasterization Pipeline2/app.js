...
function createScene() {
    ...
    groundGeometry.worldMatrix.multiply(new Matrix4().makeTranslation(0, -1, -10));
    ...
    sphereGeometry.worldMatrix.multiply(new Matrix4().makeTranslation(0, 0, -5));
    sphereGeometry.worldMatrix.multiply(new Matrix4().makeScale(.01, .01, .01));
}
...
function updateAndRender() {
    ...
    // render sphere
    var r = (Math.sin(time.secondsElapsedSinceStart)+1.0)/2.0;
    var g = (Math.sin(time.secondsElapsedSinceStart*2)+1.0)/2.0;
    var b = (Math.sin(time.secondsElapsedSinceStart*3)+1.0)/2.0;
