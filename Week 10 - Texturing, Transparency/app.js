...
function updateAndRender() {
    ...
    sphereGeometryList = sphereGeometryList.sort(function(a, b) {
        var aDistance = a.getPosition().subtract(camera.getPosition()).length();
        var bDistance = b.getPosition().subtract(camera.getPosition()).length();
