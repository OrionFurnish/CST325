...
function updateAndRender() {
    ...
    var lightRotationMatrix = new Matrix4().makeRotationY(rotation).multiply(new Matrix4().makeTranslation(5.0, 1.5, 0.0, 1.0));
    var lightPos = lightRotationMatrix.multiplyVector(new Vector4(0.0, 0.0, 0.0, 1.0));
    lightPosition = new Vector3(lightPos.x, lightPos.y, lightPos.z);
    lightSphereGeometry.worldMatrix = lightRotationMatrix.multiply(new Matrix4().makeScale(0.005, 0.005, 0.005));
